...
public class SaleOrderProjection {
    private UUID id;
    ...
    public SaleOrderProjection(SaleOrder saleOrder) {
        this(saleOrder.getId(),
                saleOrder.getCurrentVersion(),
                saleOrder.getPlacedDate(),
                saleOrder.getUnitsCount(),
                saleOrder.getPricePerUnit(),
                saleOrder.getValidTo(),
                saleOrder.getFulfillmentStatus(),
                saleOrder.isDeleted(),
